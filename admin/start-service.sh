...
CLASSPATH="lib/*:external/lib/*:external/resources:settings:admin/lib/*:admin/settings:admin/resources:$1"
...
if [ -z "${PID}" ]; then
    ...
    java $JAVA_OPTS -cp $CLASSPATH org.youngmonkeys.ezyplatform.admin.AdminStartup > /dev/null 2>&1 &
    echo $! > ${PID_FILE}
else
